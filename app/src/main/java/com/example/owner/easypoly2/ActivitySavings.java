...
public class ActivitySavings extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_activity_savings);
...
//        Double result=rate*total/(1-Math.pow(1+rate,-term));

        Double total1=total *term;

        Double result=total1 * Math.pow((1 + rate/100.0), term/12);
